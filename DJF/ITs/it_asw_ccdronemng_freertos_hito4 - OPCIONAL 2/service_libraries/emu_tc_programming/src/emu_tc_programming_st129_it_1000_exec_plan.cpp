...
#define IT_1000_TIME_step2 (OBT_AFTER_POWER_ON + 5)
#define IT_1000_TIME_step3 (OBT_AFTER_POWER_ON + 8)
#define IT_1000_TIME_step4 (OBT_AFTER_POWER_ON + 40)
#define IT_1000_TIME_step5 (OBT_AFTER_POWER_ON + 55)
...
EmuGSS_TCProgram20_3_uint8 prog_IT_1000_step_2(IT_1000_TIME_step2,
		"FT_UAH_ASW_ICU_Monitoring_0100 step 0, Set PID 15 to 5",15,5);

EmuGSS_TCProgram12_5_Limit_UINT8 prog_IT_1000_step_3(IT_1000_TIME_step3,
		"FT_UAH_ASW_ICU_Monitoring_0100 step 0B, Config PMODID 0 for monitoring PID 15",
		0, 15, 1, 2, 1, 0x4001, 20, 0x4002);

EmuGSS_TCProgram20_3_uint8 prog_IT_1000_step_4(IT_1000_TIME_step4,
		"FT_UAH_ASW_ICU_Monitoring_0100 step 0, Set PID 15 to 5",15,5);

EmuGSS_TCProgram12_5_Limit_UINT8 prog_IT_1000_step_5(IT_1000_TIME_step5,
		"FT_UAH_ASW_ICU_Monitoring_0100 step 0B, Config PMODID 0 for monitoring PID 15",
		0, 15, 1, 2, 1, 0x4001, 20, 0x4002);
