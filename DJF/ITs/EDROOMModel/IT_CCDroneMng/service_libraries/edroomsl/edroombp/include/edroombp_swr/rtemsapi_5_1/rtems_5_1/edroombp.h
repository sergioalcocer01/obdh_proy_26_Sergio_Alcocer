...
#ifndef _RTEMSAPI_RTEMS_5_1_EDROOMBP_H_
#define _RTEMSAPI_RTEMS_5_1_EDROOMBP_H_
...
typedef struct timeval EDROOMTimeSpec;
...
public:
    ...
    */
     ...
     * \return This method returns the value of the system clock in ticks.
     */
    uint32_t Secns() const {return time.tv_sec;}
...
#endif	/*_RTEMSAPI_RTEMS_5_1_EDROOMBP_H_*/
